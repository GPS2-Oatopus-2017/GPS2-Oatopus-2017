...
//#endif
		...
		private void Update ()
		{
			...
			if (CrossPlatformInputManager.GetButtonDown ("Jump") && !m_Jump || Input.GetKeyDown (KeyCode.Space) && !m_Jump) {
				m_Jump = true;
			}
		...
		private Vector2 GetInput ()
		{
			...
			Vector2 input = new Vector2 {
				...
				y = 1f//CrossPlatformInputManager.GetAxis ("Vertical")
			};
		...
		private void RotateView ()
		{
			...
			float newYRotation = oldYRotation + (CrossPlatformInputManager.GetAxis ("Horizontal") * 100 * Time.fixedDeltaTime);
